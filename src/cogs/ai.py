...
- NẾU cần thông tin mới nhất hoặc không chắc chắn về sự kiện thực tế, hãy trả lời DUY NHẤT một dòng theo định dạng: [SEARCH: <nội dung cần tìm>]. Tôi sẽ tìm kiếm và cung cấp thông tin cho ngươi sau đó.
"""
